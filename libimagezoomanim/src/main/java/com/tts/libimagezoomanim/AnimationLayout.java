...
public class AnimationLayout extends FrameLayout {
    ...
    public void expand(Rect drawRegion, TransformData object) {
        ...
        animatingImageView.setRadius(object.getRadius());
        animatingImageView.setOrientation(orientation);
        animatingImageView.setNeedRadius(object.getRadius() != 0);
        animatingImageView.setImageBitmap(object.getThumbImage());

        animatingImageView.setAlpha(1.0f);
        animatingImageView.setPivotX(0.0f);
        animatingImageView.setPivotY(0.0f);
        animatingImageView.setScaleX(object.getScale());
        animatingImageView.setScaleY(object.getScale());

        float thumbRatio = (float) object.getThumbImage().getWidth() / object.getThumbImage().getHeight();
...
//        float scaleY = (float) (AndroidUtilities.displaySizePixel.y - (useOccupyStatusBar ? statusBarHeight : 0)) / object.thumbImage.getHeight();
        ...
        int clipVertical = 0;
        if (drawRegion.bottom > (AndroidUtilities.displaySizePixel.y - object.getClipBottomAddition())) {
            clipBottom = drawRegion.bottom - ((AndroidUtilities.displaySizePixel.y) - object.getClipBottomAddition());
        }
        if (drawRegion.top < (statusBarHeight + object.getClipTopAddition())) {
            clipTop = -drawRegion.top + statusBarHeight + object.getClipTopAddition();
        }
        if (thumbRatio > imageViewRatio) {
        ...
        animationValues[0][4] = clipHorizontal * object.getScale();
        animationValues[0][5] = clipTop * object.getScale();
        animationValues[0][6] = clipBottom * object.getScale();
    ...
    public void shrink(Rect drawRegion, TransformData object) {
        ...
        if (drawRegion != null) {
            ...
            animationValues[1][0] = object.getScale();
            animationValues[1][1] = object.getScale();
            ...
            animationValues[1][4] = clipHorizontal * object.getScale();
            animationValues[1][5] = clipTop * object.getScale();
            animationValues[1][6] = clipBottom * object.getScale();
            animationValues[1][7] = object.getRadius();
